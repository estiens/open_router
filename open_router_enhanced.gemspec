...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Eric Stiens", "Obie Fernandez (original)"]
  spec.email = ["me@ericstiens.dev"]
  ...
  spec.files = Dir.chdir(__dir__) do
    `git ls-files -z`.split("\x0").reject do |f|
      (File.expand_path(f) == __FILE__) || f.end_with?(".gem", ".gemspec") || f.start_with?(*%w[bin/ test/ spec/ features/ .git
                                                                                                .circleci appveyor])
    end
  end
